...
- 模型前沿：Anthropic Mythos 1即将引入Claude Code和Claude Security，Sonnet 4.8泄露详情曝光
- 产业动态：Canonical Labs发布物理AI三年资本图谱：4家人形机器人估值565亿美元，15.6倍于6个子赛道总和
- 研究关注：Ai2发布ArtifactLinker：GNN+LLM自动发现HuggingFace上的SOTA模型; Echo框架：从用户修正行为中学习，代码补全接受率25.7%→35.7%; MIT团队提出跨域基准：多Agent协作在气候预测等科学任务上优于单Agent; Qisheng Su等将Agent交互轨迹转为长上下文训练数据，30B模型长上下文能力接近235B
...
### 模型前沿
**Anthropic Mythos 1即将引入Claude Code和Claude Security，Sonnet 4.8泄露详情曝光**
...
**MIT团队提出跨域基准：多Agent协作在气候预测等科学任务上优于单Agent**
