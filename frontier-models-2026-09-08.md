...
**AI4AI 的实际收益已进入训练供给和计算系统，开放研究仍依赖人类判断。** 智谱披露环境与验证器生成，OpenAI、Kimi 等披露实际内核研发使用；这些工作已有可验证产物。研究方向选择和结果迁移更难自动化，OpenAI 成功完成的 4—8 小时任务中，超过一半仍接受过人类介入。[厂商实践与研究证据](#s6)
