...
- 模型前沿：字节跳动Seed团队发布Seedance 2.5，单次生成30秒视频并支持多模态参考与精准编辑
- 产业动态：Stone Tao加入Physical Intelligence全职研究仿真，实习约六周即转正；Perplexity将Spaces升级为Projects，引入持久文件系统与Brain自我改进记忆
- 研究关注：Explorative Modeling提出预训练"第三轴"探索，6.2×数据效率与1.43 FID；CG-World发布85万段CG对齐数据集，带反事实分支面向世界模型；清华OpenBMB提出ALIGN自动生成对齐接口，ALFWorld成功率提升45.67%；腾讯Hyra研究代理辅助解决50年和集-差集最优指数难题
- X讨论：swyx与Simon Willison讨论AI实验室自建搜索索引趋势，Anthropic新增TurboPuffer作为搜索子处理者
...
- Seedance 2.5延续2.0的多模态音视频联合生成架构，重点突破长叙事、多模态参考和编辑能力。**单次生成时长从15秒提升至30秒**，支持多轮延长以生成数分钟连贯内容，模型优化了镜头衔接和场景过渡。多模态参考方面支持单次输入**最多30张图片、10段视频、10段音频**作为参考素材，综合理解构图、场景、风格、人物等元素，并提升白模参考、运动参考、创意参考能力。编辑方面支持时间戳精准控制、绿幕编辑、视角编辑、参考编辑等。模型系统优化了视频生成中常见的"油腻感"问题，减少字幕与背景音乐不受控的情况。已在即梦AI、豆包专业版上线，API将近期上线火山方舟。
...
### 产业动态
**Stone Tao加入Physical Intelligence全职研究仿真，实习约六周即转正**
- Stone Tao宣布加入Physical Intelligence (Pi) 全职负责仿真研究，距其开始实习仅约六周。Lucas Beyer评价称这可能是"史上最快的实习转正"。Tao表示选择Pi的原因是其研究影响力、对仿真研究的深层理解以及给予研究者的高度自主权。他此前用两周时间不写代码而是观看上千条真实评估视频，梳理仿真如何补充和指导真实评估。他将负责Pi的长期仿真战略和可扩展仿真框架建设，重点关注任务生成、仿真数据协同训练、基于仿真的缩放定律等方向。Tao认为Pi的研究者影响力（如推动行业转向VLA模型和遥操作）创造了有利于加速研究的外部生态。
  > 💡 Pi此前以VLA模型和遥操作见长，Tao的加入标志着仿真研究在其路线图中获得更高优先级；头部机器人公司对仿真人才的争夺正在加剧，仿真被视为具身智能scaling的关键瓶颈。
   - 来源: [@Stone_Tao](https://x.com/Stone_Tao/status/2082980966361084103) | [Substack](https://stoneztao.substack.com/p/joining-physical-intelligence-to)
