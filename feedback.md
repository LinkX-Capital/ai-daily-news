...
| **body — 事实密度** | #09🔗 | 必须有量化数据（合并至 #29） |
| **body — 事实密度** | #29 | 必须有benchmark数据点 |
...
| **body — body vs insight** | #35 | body自检黑名单（具体违规句式） |
| **body — 绝对性判断** | #24🔗 | 禁止"首个/首次"无来源（合并至 #32） |
| **body — 绝对性判断** | #25🔗 | 禁止"首选/核心地位"无来源（合并至 #32） |
| **body — 绝对性判断** | #32 | 禁止无来源绝对性判断（统一规则） |
| **body — 降级/截断** | #23 | 来源不可达时标注⚠️只写最小事实集 |
| **body — 降级/截断** | #33 | ⚠️标注应覆盖body所有具体声明 |
| **body — 降级/截断** | #37 | 截断检测：单字结尾/未闭合引号触发重新生成 |
| **body — 写前必读原文** | #22 | 写body前必须读原文，区分报道者和研究者 |
