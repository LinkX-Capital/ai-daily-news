...
```
 ...
 模型  │  OpenAI 通用模型解 Erdős 单位距离难题    腾讯 Hy-MT2 1.25-bit/440MB
...
| ARC-AGI-3 | **新战场** | Claude Opus 4.8 | **1.5%**（~$10K） | 人类 100%，Opus 4.8 新 SOTA，较 GPT-5.5 的 0.43% 提升 3.5× |
