...
- 算力追踪：SpaceX 为 AI 数据中心筹划涡轮叶片工厂，自行解决电力供给瓶颈
...
- Caterpillar 正把在自动化矿山中积累的远程运维、设备可靠性和复杂现场部署经验，迁移到 AI 部署场景。报道称，这家公司希望把工业系统中的自动化、远程运维和复杂现场部署能力用于 AI 项目落地。
...
### 算力追踪
**SpaceX 为 AI 数据中心筹划涡轮叶片工厂，自行解决电力供给瓶颈**
- 据报道，SpaceX 正在为 AI 数据中心筹建涡轮叶片工厂，目标是自行制造燃气轮机的高复杂度零部件。报道将此举定性为 Musk 试图绕过现有 AI 数据中心电力供应链的举动，并提到 GE Vernova、Anthropic、摩根士丹利、英伟达与 Bastrop、Texas 等相关方和地点。
  > 💡 电力而非 GPU 正在成为 AI 数据中心扩张的硬约束，向"自造燃气轮机关键件"延伸说明头部玩家愿意进入传统能源重型装备制造以保住算力上线节奏。
   - 来源: [The Information](https://www.theinformation.com/articles/exclusive-spacex-lays-groundwork-turbine-blade-factory-solve-data-center-power-crunch)

### 初创&融资
**Anthropic 据报曾试图以约 70 亿美元收购 AI 芯片公司 MatX**
- 据报道，Anthropic 曾讨论以约 **70 亿美元** 收购 AI 芯片初创 MatX，但最终未推进这笔交易。报道还称，Anthropic 与 MatX 的谈判发生在 AI 公司扩大算力采购和自研芯片讨论升温的背景下。
