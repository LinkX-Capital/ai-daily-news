...
**4. NVIDIA盘点物理AI机器人研究突破，推动AI进入现实物理世界**
- 内容涵盖机器人运动控制、感知融合、具身智能等领域的最新研究成果和资源。
[来源: NVIDIA Blog](https://blogs.nvidia.com/blog/national-robotics-week-2026/)

### 算力追踪
**5. SemiAnalysis披露NVIDIA Rubin芯片TDP飙升至2300W，功耗挑战巨大**
- Rubin芯片TDP从Blackwell的1000-1400W飙升至2300W，传统风冷方案可能无法支撑下一代AI训练集群。
[来源: @SemiAnalysis_](https://x.com/SemiAnalysis_/status/2041259953998946455#m)

**6. Gemma 4支持iPhone本地运行，零token延迟时代临近**
- 在Arena AI排行榜位列全球第三，多个型号可实现在iPhone等移动设备本地运行，引发业界对端侧AI的广泛讨论。
...
- 用户可以将手伸入屏幕进行交互，该研究为人机交互和世界模型应用提供了新的可能性。
[来源: PaperWeekly](https://mp.weixin.qq.com/s?__biz=MzIwMTc4ODE0Mw==&mid=2247719254&idx=2&sn=2117d3e36caa37fc3a8962c14b80cb49)

### X讨论
**13. 开源模型首次在评测中击败Claude Sonnet 4.6**
- OpenRouter转推：首次有开源模型在OpenRouter评测中超越Claude Sonnet 4.6，目前正在vibe testing阶段。
