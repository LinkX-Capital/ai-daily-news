...
def build_screenshot_html(md_content, title_override=None):
    """渐变背景 + 白色卡片布局"""
    articles, summary_items = parse_md_screenshot(md_content)

    today_str = title_override or "5月1日到5月5日重点汇总"
...
async def generate_screenshot():
    md_file = "/Users/shenyalan/ai-daily-news/weekly-2026-05-05.md"
    output_file = "/Users/shenyalan/ai-daily-news/weekly-2026-05-05.png"

    with open(md_file, 'r', encoding='utf-8') as f:
        md_content = f.read()

    screenshot_html = build_screenshot_html(md_content, title_override="5月1日–5月5日重点汇总")
