...
**厦门大学&港科大提出MAGE离线强化学习算法**
- 厦门大学和香港科技大学提出MAGE（Multi-scale Autoregressive Generation）离线强化学习算法，让离线强化学习从局部合理走向全程流畅。该研究改进传统离线强化学习仅关注单步决策的局限，通过多尺度自回归生成实现整体策略的全局优化。
